    ...
    request("/user/"+$('#userdata').attr("data-userid")+"/groups", "GET")
        .then(function(d) {
            ...
            d["groups"].forEach(function(k) {
                ...
                $('#myGroups').append('<div class="row" style="margin-bottom:1rem;margin-top:1rem;"><div class="col-12 col-md-4" style="padding-right:0;"><img style="width:100%;" data-catalogid="'+k.groupIconCatalogId+'" /></div><div class="col-6 col-md-8"><p class="text-truncate"><a href="/groups/'+k.groupId+'/'+urlencode(k.groupName)+'">'+k.groupName.escape()+'</a></p></div></div>');
            });
