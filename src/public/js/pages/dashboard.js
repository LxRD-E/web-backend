        ...
        .then((data)=>{
            ...
            data.forEach(function(k,v) {
                //if (v < 5) {
                    ...
                    $('#userFeedDiv').append('<div class="col-sm-12"><hr /></div><div style="" class="col-4 col-lg-2"><img style="width:100%;" data-userid="'+k.userId+'" src="'+window.subsitutionimageurl+'" /></div><div class="col-8 col-lg-10"><div class="row"><div class="col-12"><a style="color:#212529;" href="/users/'+k.userId+'/profile"><h6 class="text-left" style="margin-bottom: 0;" data-userid="'+k.userId+'"></h6></a></div><div class="col-12"><p class="text-left" style="font-size: small;">'+dateDisplay+'</p></div><div class="col-12 col-sm-9 col-lg-10"><p>'+k["status"].escape()+'</p></div></div></div>');
                //}
            });
